...
<html>
                    ...
                    if(isset($_POST['upload'])){
                        ...
                        if(in_array($file_extension, $extensions_autorisees)){
                            if (move_uploaded_file($file_tmp_name, $file_dest)) {
                                $req = $pdo->prepare("INSERT INTO adhesion (file, file_url, create_at,title) VALUES (?,?,NOW(),?)");
                                ...
                                $errors['file'] = "Format du Fichier non autorisé";
                            }
                        }
                        $req->closeCursor();
                    }
    ...
    <div class="row rounded justify-content-center mt-3">
        <div class="col-md-4 pl-2 pr-2 pb-3 pt-3">
            <h1 class="text-center">Ajouter une condition</h1>
