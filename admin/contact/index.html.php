...
<div class="container rounded bg-white pl-5 pt-2 pb-3 pr-5 mt-5">
        ...
        <?php while($donnee = $req->fetch()): ?>
            <tr>
                ...
                <td class="text-center">
                    <?php
                    echo "<img src='../files/".$donnee['image']."' alt='image' style='height: 40px; width: 40px;'/> "
                    ?>
                </td>
                <td class="text-center"><?php echo $donnee['nom']; ?></td>
                <td class="text-center"><?php echo $donnee['email']; ?></td>
                <td class="text-center"><?php echo $donnee['poste']; ?></td>
                <td class="text-center">
